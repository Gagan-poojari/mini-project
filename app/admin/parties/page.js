...
export default function AdminPartiesPage() {
  ...
  return (
    <AdminRoute>
      <div className="min-h-screen  bg-linear-to-br from-gray-950 via-gray-900 to-black text-white py-12 px-6 lg:px-10">
        <div className="max-w-7xl mx-auto">
          {/* Header Section */}
          <div className="flex justify-between items-center mb-10">
            <div>
              <h1 className="text-4xl font-extrabold text-gray-200 tracking-tight">Manage Parties</h1>
              <Link
                href="/admin"
          ...
          {loading ? (
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
              {parties.map((party) => (
                <div
                  key={party.id}
                  className="bg-white/0  rounded-2xl shadow-sm border border-gray-100 hover:shadow-lg hover:-translate-y-1 transition-all duration-300 p-6 flex flex-col justify-between"
                >
                  <div>
                    {party.logo && (
                    ...
                    <div className="text-center">
                      <h3 className="text-xl font-bold text-gray-200 mb-1">{party.name}</h3>
                      {party.shortName && (
        ...
        {showModal && (
          <div className="fixed inset-0 bg-gray-900/80 flex items-center justify-center p-4 z-50">
            <div className="bg-gray-800 rounded-2xl max-w-md w-full p-6 shadow-2xl border border-gray-100 animate-fadeIn">
              ...
              <form onSubmit={handleSubmit} className="space-y-5">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 border placeholder-gray-600 border-gray-300 rounded-md focus:ring-2 focus:ring-green-500 focus:border-green-500"
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-3 py-2 placeholder-gray-600 border border-gray-300 rounded-md focus:ring-2 focus:ring-green-500 focus:border-green-500"
                    placeholder="e.g., PDP"
                  />
                </div>
