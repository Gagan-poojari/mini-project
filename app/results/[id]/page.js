  ...
  return (
    <div className="min-h-screen bg-linear-to-br from-gray-950 via-gray-900 to-black text-white py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-4xl mx-auto space-y-8">
        ...
        {/* Election Header */}
        <div className="text-center bg-white/0 rounded-2xl shadow-md p-8 border border-gray-100">
          ...
          <div className="flex flex-wrap justify-center gap-8 text-sm">
            <div>
              ...
              <span className="font-semibold ml-2 text-gray-200">{data.totalVotes || 0}</span>
            </div>
            <div>
              <span className="text-gray-300">Start:</span>
              <span className="font-semibold ml-2 text-gray-200">
          ...
          <p className="text-xs text-gray-100 mt-3 italic">
        ...
        {winner && winner.voteCount > 0 && (
          <div className="bg-white/0 border-yellow-400 rounded-2xl p-6 shadow-lg">
            <div className="flex items-center justify-between">
              <div className="flex-1">
                <div className="text-sm font-semibold text-yellow-700 mb-1 tracking-wide">
                  🏆 LEADING CANDIDATE
                </div>
                <h2 className="text-3xl font-bold text-gray-200 mb-1">{winner.name}</h2>
                <p className="text-gray-200">{winner.profession}</p>
              ...
              <div className="text-right">
                ...
                <div className="text-sm text-gray-200">{winner.percentage}% of votes</div>
              </div>
            </div>
          </div>
        )}
        ...
        <div className="space-y-4">
          {data.results.map((candidate, index) => (
            <div
              key={candidate.id}
              className="bg-white/0 border border-gray-200 rounded-2xl p-6 hover:shadow-xl transition-shadow duration-300"
            >
              <div className="flex items-center justify-between mb-3">
                <div className="flex items-center space-x-4 flex-1">
                  ...
                  <div className="flex-1">
                    ...
                    <p className="text-sm text-gray-300">{candidate.profession}</p>
              ...
              <div className="w-full bg-gray-200 rounded-full h-3 overflow-hidden">
                <div
                  className="bg-linear-to-r from-blue-500 to-blue-700 h-3 rounded-full transition-all duration-700 ease-out"
        ...
        {/* No Votes Message */}
        {data.totalVotes === 0 && (
          <div className="text-center text-gray-200 mt-12 bg-white/0 rounded-2xl shadow-lg p-12 border border-gray-100">
